...
/*---------------------------- USART BRR Configuration -----------------------*/
  ...
  {
    apbclock = RCC_ClocksStatus.PCLK2_Frequency/100;
  }
  else
  {
    apbclock = RCC_ClocksStatus.PCLK1_Frequency/100;
  }
  ...
  if ((USARTx->CR1 & CR1_OVER8_Set) != 0)
  {
    ...
    integerdivider = ( (25 * apbclock)/ (2 * (USART_InitStruct->USART_BaudRate/100)));    
  }
  else /* if ((USARTx->CR1 & CR1_OVER8_Set) == 0) */
  {
    /* Integer part computing in case Oversampling mode is 16 Samples */
    integerdivider = ( (25 * apbclock) / (4 * (USART_InitStruct->USART_BaudRate/100)));    
  }
