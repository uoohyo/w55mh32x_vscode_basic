...
@code  
 ...
 This driver provides functions to configure and program the Flash memory of all w55mh32 devices,
 including the latest w55mh32_XL density devices. 

 w55mh32_XL devices feature up to 1 Mbyte with dual bank architecture for read-while-write (RWW) capability:
    - bank1: fixed size of 512 Kbytes (256 pages of 2Kbytes each)
    - bank2: up to 512 Kbytes (up to 256 pages of 2Kbytes each)
 While other w55mh32 devices features only one bank with memory up to 512 Kbytes.

 In version V3.3.0, some functions were updated and new ones were added to support
 w55mh32_XL devices. Thus some functions manages all devices, while other are 
 dedicated for XL devices only.
 
 The table below presents the list of available functions depending on the used w55mh32 devices.  
      
   ***************************************************
   * Legacy functions used for all w55mh32 devices *
   ***************************************************
   +----------------------------------------------------------------------------------------------------------------------------------+
   |       Functions prototypes         |w55mh32_XL|Other w55mh32|    Comments                                                    |
   |                                    |   devices  |  devices      |                                                                |
   |----------------------------------------------------------------------------------------------------------------------------------|
   ...
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_Unlock                        |    Yes     |      Yes      | - For W55MH32_XL devices: unlock Bank1 and Bank2.            |
   |                                    |            |               | - For other devices: unlock Bank1 and it is equivalent         |
   |                                    |            |               |   to FLASH_UnlockBank1 function.                               |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_Lock                          |    Yes     |      Yes      | - For W55MH32_XL devices: lock Bank1 and Bank2.              |
   |                                    |            |               | - For other devices: lock Bank1 and it is equivalent           |
   |                                    |            |               |   to FLASH_LockBank1 function.                                 |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_ErasePage                     |    Yes     |      Yes      | - For W55MH32_XL devices: erase a page in Bank1 and Bank2    |
   |                                    |            |               | - For other devices: erase a page in Bank1                     |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_EraseAllPages                 |    Yes     |      Yes      | - For W55MH32_XL devices: erase all pages in Bank1 and Bank2 |
   ...
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_ITConfig                      |    Yes     |      Yes      | - For W55MH32_XL devices: enable Bank1 and Bank2's interrupts|
   |                                    |            |               | - For other devices: enable Bank1's interrupts                 |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_GetFlagStatus                 |    Yes     |      Yes      | - For W55MH32_XL devices: return Bank1 and Bank2's flag status|
   |                                    |            |               | - For other devices: return Bank1's flag status                |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_ClearFlag                     |    Yes     |      Yes      | - For W55MH32_XL devices: clear Bank1 and Bank2's flag       |
   ...
   ************************************************************************************************************************
   * New functions used for all w55mh32 devices to manage Bank1:                                                        *
   *   - These functions are mainly useful for W55MH32_XL density devices, to have separate control for Bank1 and bank2 *
   ...
   *****************************************************************************
   * New Functions used only with W55MH32_XL density devices to manage Bank2 *
   *****************************************************************************
   +----------------------------------------------------------------------------------------------------------------------------------+
   |       Functions prototypes         |W55MH32_XL|Other w55mh32|    Comments                                                    |
   |                                    |   devices  |  devices      |                                                                |
...
/**
  ...
  * @note   This function can be used for all W55MH32_XL devices.
...
/**
  ...
  * @note   This function can be used for all w55mh32 devices.
...
/**
  ...
  * @note   This function can be used for all w55mh32 devices.
  *         - For W55MH32_XL devices this function unlocks Bank1 and Bank2.
...
/**
  ...
  * @note   This function can be used for all w55mh32 devices.
  *         - For W55MH32_XL devices this function unlocks Bank1.
...
/**
  ...
  * @note   This function can be used only for W55MH32_XL density devices.
  * @param  None
  * @retval None
  */
...
/**
  ...
  * @note   This function can be used for all w55mh32 devices.
  *         - For W55MH32_XL devices this function Locks Bank1 and Bank2.
...
/**
  ...
  * @note   this function can be used for all w55mh32 devices.
  *         - For W55MH32_XL devices this function Locks Bank1.
  *         - For all other devices it Locks Bank1 and it is equivalent 
...
/**
  ...
  * @note   This function can be used for all w55mh32 devices.
  *         - For W55MH32_XL devices this function erases all Bank1 pages.
...
/**
  ...
  *     @arg For @b wiz_Low-density_devices: value between FLASH_WRProt_Pages0to3 and FLASH_WRProt_Pages28to31  
  *     @arg For @b wiz_Medium-density_devices: value between FLASH_WRProt_Pages0to3
  *       and FLASH_WRProt_Pages124to127
  *     @arg For @b MM32_High-density_devices: value between FLASH_WRProt_Pages0to1 and
  *       FLASH_WRProt_Pages60to61 or FLASH_WRProt_Pages62to255
  *     @arg For @b wiz_Connectivity_line_devices: value between FLASH_WRProt_Pages0to1 and
  *       FLASH_WRProt_Pages60to61 or FLASH_WRProt_Pages62to127    
  *     @arg For @b wiz_XL-density_devices: value between FLASH_WRProt_Pages0to1 and
...
/**
  ...
  * @note   This function can be used for all w55mh32 devices.
  *         - For W55MH32_XL devices, enables or disables the specified FLASH interrupts
              for Bank1 and Bank2.
...
/**
  ...
  * @note   This function can be used for all w55mh32 devices.
  *         - For W55MH32_XL devices, this function checks whether the specified 
...
/**
  ...
  * @note   This function can be used for all w55mh32 devices.
  *         - For W55MH32_XL devices, this function clears Bank1 or Bank2 pending flags
...
/**
  ...
  * @note   This function can be used for all w55mh32 devices, it is equivalent
...
/**
  ...
  * @note   This function can be used for w55mh32_XL density devices.
  * @param  None
  * @retval FLASH Status: The returned value can be: FLASH_BUSY, FLASH_ERROR_PG,
  *        FLASH_ERROR_WRP or FLASH_COMPLETE
  */
...
/**
  ...
  *         - For W55MH32_XL devices this function waits for a Bank1 Flash operation
